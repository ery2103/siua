...
// senayan version
define('SENAYAN_VERSION', 'Sistem Arisp v0.1');
...
//$sysconf['mysqldump'] = '/xampp/mysql/bin';
$sysconf['mysqldump'] = '/Program Files/MySQL/MySQL Server 5.7/bin';
...
$sysconf['page_footer'] = ' <strong>Powered By SLiMS</strong>';
...
$sysconf['authority_type']['c'] = __('Additional');
